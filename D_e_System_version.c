...
void D_e_Sys_v_run() {
    ...
    draw_text(framebuffer, 250, 90, "| Kernel version: D.Kernel 0.3                                                                             |", 0xFFFFFF);
    draw_text(framebuffer, 250, 100, "|                                                                                                          |", 0xFFFFFF);
    draw_text(framebuffer, 250, 110, "| D.eSystem version: D.eSystem 6.0.4.5 alpha                                                               |", 0xFFFFFF);
    draw_text(framebuffer, 250, 120, "|                                                                                                          |", 0xFFFFFF);
    draw_text(framebuffer, 250, 130, "| UI version: D.Touch UI ASCII edition                                                                     |", 0xFFFFFF);
    draw_text(framebuffer, 250, 140, "|                                                                                                          |", 0xFFFFFF);
    draw_text(framebuffer, 250, 150, "| UX version: Text UX                                                                                      |", 0xFFFFFF);
    ...
    draw_text(framebuffer, 250, 190, "| Codename: real                                                                                           |", 0xFFFFFF);
